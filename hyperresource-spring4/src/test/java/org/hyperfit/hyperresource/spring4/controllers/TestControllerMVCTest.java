...
import org.hyperfit.hyperresource.spring4.converters.WriteOnlyHyperResourceMessageConverter;
...
public class TestControllerMVCTest {
    ...
    public void testRespondsWithHandlebars() throws Exception {
        ...
        String oneIn = TestUtils.uniqueString();
        String twoIn = TestUtils.uniqueString();
